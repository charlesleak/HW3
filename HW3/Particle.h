...
class particle {
  private:
    ...
    double time;                      // the last time the particle interacted [ns]
    double energy;                    // energy of the particle since last interaction [MeV]
  public:
    ...
    double getTime() { return time; };                         // return the last time the particle interacted
    void stepTime( double t ) { time += t; };                  // step forward time by the time elapsed
    double getEnergy() { return energy; };                     // return energy of the particle
    void setEnergy( double E ) { energy = E; };               // changes energy to E
};
